...
const Cart = () => {
  ...
  return (
    <div className='mt-[10%] xs:mt-[20%] ml-[5%] xs:ml-[8%]'>
          ...
          <ul>
            {userCart.map((item, index) => (
              <li key={index} className="flex items-center mt-2 justify-between py-4">
                ...
                <div className="shadow-xl xs:absolute xs:ml-2 hidden xs:flex bg-no-repeat bg-cover rounded-full xs:top-[5%] xs:left-[2%] border-[5px] border-[#EB5554] w-[200px] h-[200px] xs:w-[130px] xs:h-[130px]" style={{ backgroundImage: `url(${item.img})` }}></div>
                  <div className='flex pl-7 flex-col gap-3 w-[50%]'>
                    ...
                    <div className='flex mt-[25px] xs:mt-[80%] gap-8'>
                      ...
                      <p className='text-[18px] xs:absolute xs:bottom-[8%] xs:left-[3%] font-medium text-green-600'>Price: ₹ {item.price}</p>
                    </div>
                  ...
                  <div className='flex justify-center gap-14 items-center flex-col ml'>
                    <div className='flex xs:absolute xs:bottom-[8%] xs:right-[35%] mt-4 gap-3'>
